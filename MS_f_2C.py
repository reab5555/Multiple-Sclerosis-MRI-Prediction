...
main_folder = r"C:\Works\Data\projects\Python\Projects\MS\set2\Multiple Sclerosis\balanced\2C"
folders = [
    'NON-MS',
    'MS'
]
...
torch.save(model.state_dict(), 'final_ms_model_2classes_vit_base_224_bce.pth')
print("Final model saved as 'final_ms_model_2classes_vit_base_224_bce.pth'")